...
const nombre  = localStorage.getItem('nombre')  || (usuario ? usuario.split('@')[0] : '');
...
function abrirMapa() {
  ...
  if (!mapaGrande) {
    ...
    L.marker([LAT, LNG], { icon: iconoRojo })
      .addTo(mapaGrande)
      .bindPopup('<b>⚠ Incendio en Almacén</b><br>Av. del Mar #123, Mazatlán')
      .openPopup();
  } else {
